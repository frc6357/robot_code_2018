...
public class Robot extends IterativeRobot
{
	...
	public void robotInit()
	{
		...
		// LEFT 10,11,15
		// RIGHT 12,14,16
		// THE TALONS ARE SET UP TO USE FOLLOWING, so we only need the front
		// left and
		// front right
		...
		// Subsystems
		gearDeploymentSystem = new GearDeploymentSystem(gearDoubleSolenoidLeft, gearDoubleSolenoidRight,
				gearDoubleSolenoidPush);
	...
	public void teleopPeriodic()
	{
		...
		if (Math.abs(leftDrive) < 0.05) // used to correct robot moving when its
										// not supposed to
		{
			leftDrive = 0.0f;
		}
