...
public class DriveBaseSystem extends Subsystem // MARK: BreakPoint
{
			...
			Encoder baseRightEncoder)
	{
		...
		// leftSide = new VelocityControlledDrivetrainSide(leftSpeedController,
		// new
		// EncoderSpeedForPID(leftEncoder));
		// rightSide = new
		// VelocityControlledDrivetrainSide(rightSpeedController, new
	...
	public void rotateRobot(double angle) // Assign speed to the motors to
											// execute the turn
	{
	...
	public void AdjustAngle(double angle) // Makes an adjustment in robot course
											// in case of change in course
	{
		// double angleError = angle - myIMU.getAngleY();

	}

	public void DriveStraight(double distance) // Drives straight during
												// autonomous
	{
	...
	public void Update()
	{
		...
		// But if we are not, then we are in position mode and need to correct
		// for drift
		if (!isInVelocityMode)
		{
